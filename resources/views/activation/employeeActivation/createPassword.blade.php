                ...
                <div class="row w-100 mx-0">
                    <div class="col-lg-4 mx-auto mt-5">
                        ...
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                            ...
                            <h4 class="mt-3">Criando uma senha!</h4>
                            <h6 class="fw-light">Por favor, digite uma senha.</h6>
                            <form class="pt-3" action="{{route('activation.set-password')}}" method="post">
                                @csrf
                                ...
                                <div class="form-group">
                                    <input type="password" class="form-control form-control-lg" name="confirm_password" placeholder="Confirme a senha">
                                    @if ($errors->has('confirm_password'))
                                    <h6 class="mt-1 text-danger">&nbsp;*&nbsp;{{$errors->first('confirm_password')}}</h6>
                                    @endif
                                </div>
                                <div class="mt-3">
